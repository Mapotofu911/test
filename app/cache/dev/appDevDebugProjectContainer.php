...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.example_listener' => 'getApp_ExampleListenerService',
    ...
    /**
     * Gets the public 'app.example_listener' shared service.
     *
     * @return \AppBundle\Listener\ExampleEventListener
     */
    protected function getApp_ExampleListenerService()
    {
        return $this->services['app.example_listener'] = new \AppBundle\Listener\ExampleEventListener($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('app.event.get_user', array(0 => 'app.example_listener', 1 => 'onGetUser'), 0);
        $instance->addListenerService('app.event.get_one_user', array(0 => 'app.example_listener', 1 => 'onGetOneUser'), 0);
        $instance->addListenerService('app.event.create_user', array(0 => 'app.example_listener', 1 => 'onCreateUser'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'skill-test-01-develop', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7cf10b0aba1f7ccefb0c3d8a98368623e5d98ce3b72c82ace56c44876ad6a19a');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bb76c5a9ca464.85336915')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'skill-test-01-develop',
            'database_user' => 'root',
